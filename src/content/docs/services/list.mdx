...
<Project name="Satisfactory Dedicated Server"
  chips={[
    { icon: "download", href: "https://www.satisfactorygame.com/", title: "Buy the game" }
  ]}
  tech={[]}
>
  Satisfactory server for me and an IRL friend.
</Project>